...
public class KorMorphemeTest {
  ...
  public void testDefault() throws IOException, URISyntaxException {
    ...
    MapDifference<String, Integer> mapA = syn.diffString("1.하루에 담배 담배 보통 몇 개비나 피우십니까?", "1.하루에 보통 몇 개비나 피우십니까?");
    
    MapDifference<String, Integer> mapB = syn.diffString("2.아침에 일어나서 얼마 만에 첫 담배를 피우십니까?", "4.하루중 담배 맛이 가장 좋은 때는 언제입니까?");
